...
- **Campione ridotto:** 52 testi generati utilizzabili e solo 16 testi reali (2 brani di fado non reperiti su Genius, 2 testi generati esclusi per traduzione fallita anche dopo i tentativi) sono un volume contenuto per conclusioni quantitative definitive.
- **Dipendenza dalla traduzione automatica:** il confronto passa per una traduzione in italiano dei testi non italiani; la qualità di `deep-translator`, non validata linguisticamente da un parlante nativo per ogni lingua coinvolta, resta un fattore esterno al fenomeno studiato.
